...
from ctx_evaluate.layers.input_quality import score, cosine_similarity
...
class TestEmptyRecord:
    def test_no_chunks(self):
        ...
        assert score(rec, InputQualityPolicy()) is None
...
class TestRelevance:
    def test_uses_rerank_score_when_no_embedding(self):
        ...
        result = score(rec, InputQualityPolicy())
    ...
    def test_embedding_fn_used_when_provided(self):
        ...
        result = score(rec, InputQualityPolicy(), embedding_fn=fake_embed)
